...
class Query {
   ...
   * @private
   */
  leftJoin (table, t1field, t2field, comparison, rawStr) {
    return this._join('LEFT', table, t1field, t2field, comparison, rawStr)
  }
   ...
   * @private
   */
  rightJoin (table, t1field, t2field, comparison, rawStr) {
    return this._join('RIGHT', table, t1field, t2field, comparison, rawStr)
  }
   ...
   * @private
   */
  innerJoin (table, t1field, t2field, comparison, rawStr) {
    return this._join('INNER', table, t1field, t2field, comparison, rawStr)
  }
  ...
  orderBy (field, order) {
    ...
    const orderBy = this._orderStr.indexOf('ORDER BY') > -1 ? ',' : 'ORDER BY'
    this._orderStr += ` ${orderBy} ${this._table}.${field} ${order}`
    return this
  }
  ...
  orderRaw (orderStr) {
    const orderBy = this._orderStr.indexOf('ORDER BY') > -1 ? ',' : 'ORDER BY'
    this._orderStr += ` ${orderBy} ${orderStr}`
    return this
  }
